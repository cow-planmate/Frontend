  ...
  return (
    <div className="relative pr-0 pl-0 right-0 left-0">
      ...
      <div className=" flex flex-col items-center ">
        <img
          src={img1}
          className=" w-[140rem] h-[41rem] object-cover bg-gradient-to-b "
        />
        <div className="absolute top-[5rem] max-h-[41rem] inset-0 bg-gradient-to-b from-transparent to-black/60 pointer-events-none"></div>{" "}
      </div>
