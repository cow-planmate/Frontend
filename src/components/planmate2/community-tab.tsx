      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8">
          <div className="bg-gradient-to-r from-orange-50 to-red-50 rounded-xl shadow-md p-6 border-2 border-orange-200">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex gap-2">
                <button onClick={() => setTrendingPeriod('daily')} className={`px-4 py-2 rounded-xl text-sm font-medium transition-all ${trendingPeriod === 'daily' ? 'bg-gradient-to-r from-orange-400 to-red-500 text-white shadow-md' : 'bg-white text-[#666666] hover:bg-orange-100'}`}>일일</button>
                <button onClick={() => setTrendingPeriod('weekly')} className={`px-4 py-2 rounded-xl text-sm font-medium transition-all ${trendingPeriod === 'weekly' ? 'bg-gradient-to-r from-orange-400 to-red-500 text-white shadow-md' : 'bg-white text-[#666666] hover:bg-orange-100'}`}>주간</button>
                <button onClick={() => setTrendingPeriod('monthly')} className={`px-4 py-2 rounded-xl text-sm font-medium transition-all ${trendingPeriod === 'monthly' ? 'bg-gradient-to-r from-orange-400 to-red-500 text-white shadow-md' : 'bg-white text-[#666666] hover:bg-orange-100'}`}>월간</button>
              </div>
            </div>
            
            <div className="space-y-3">
              {TRENDING_POSTS[trendingPeriod].map((post, index) => (
                <div key={post.id} className="bg-white p-4 rounded-xl hover:shadow-lg transition-all cursor-pointer group">
                  <div className="flex gap-4">
                    <div className={`flex items-center justify-center w-12 h-12 rounded-xl font-bold text-lg flex-shrink-0 ${index === 0 ? 'bg-gradient-to-br from-yellow-400 to-orange-500 text-white shadow-md' : index === 1 ? 'bg-gradient-to-br from-gray-300 to-gray-400 text-white shadow-md' : index === 2 ? 'bg-gradient-to-br from-amber-600 to-amber-700 text-white shadow-md' : 'bg-[#f8f9fa] text-[#666666]'}`}>{index + 1}</div>
          ...
          <div className="bg-white rounded-xl shadow-md p-6">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 bg-blue-50 rounded-xl flex items-center justify-center"><MessageSquare className="w-6 h-6 text-[#1344FF]" /></div>
          ...
          <div className="bg-white rounded-xl shadow-md p-6">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 bg-purple-50 rounded-xl flex items-center justify-center"><Users className="w-6 h-6 text-purple-500" /></div>
          ...
          <div className="bg-white rounded-xl shadow-md p-6">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 bg-orange-50 rounded-xl flex items-center justify-center"><HelpCircle className="w-6 h-6 text-orange-500" /></div>
