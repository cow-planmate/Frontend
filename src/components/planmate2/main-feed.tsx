...
export default function MainFeed({ onNavigate }: MainFeedProps) {
  ...
  const sortedPosts = [...filteredPosts].sort((a, b) => {
    ...
    if (sortBy === '가져가기순') return b.forks - a.forks;
    return 0; // 최신순은 기본 순서
  });
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-4">
                ...
                <div className="mt-3">
                  ...
                  <p className="text-xs text-[#666666] mt-1">다음 레벨까지 22회 남았어요!</p>
                </div>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-3 p-2 rounded-xl bg-gray-50">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-400">0-49회 가져감</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-2 rounded-xl bg-blue-50 border-2 border-[#1344FF]">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-[#1344FF]">50-99회 가져감</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-2 rounded-xl">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-[#666666]">100-199회 가져감</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-2 rounded-xl">
                  <Star className="w-4 h-4 text-[#666666]" />
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-[#666666]">200-499회 가져감</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-2 rounded-xl">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-[#666666]">500회 이상 가져감</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-br from-[#1344FF] to-[#0d34cc] rounded-xl shadow-md p-6 text-white">
            ...
            <button
              ...
              className="w-full bg-white text-[#1344FF] py-2 rounded-xl font-medium hover:bg-gray-50 transition-colors"
            >
              커뮤니티 가기
            </button>
          </div>
