...
import { ArrowLeft, Heart, Copy, Share2, MapPin, Calendar, Users, Car, Clock, MessageCircle, Send, ChevronDown, ChevronUp, CornerDownRight, Utensils, Coffee, Camera, ShoppingBag, Landmark, Star, Flag } from 'lucide-react';
...
const MOCK_COMMENTS: Comment[] = [
  {
    ...
    content: '와 일정이 정말 알차네요! Fork해서 제 일정으로 사용하고 싶어요. 혹시 경복궁 입장료는 얼마였나요?',
    createdAt: '2시간 전',
    likes: 5,
    replies: [
      {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden">
                            ...
                            <div className="p-5 flex flex-col justify-between flex-1">
                              <div>
                                <div className="flex items-center gap-2 mb-2">
                                  <span className={`px-2 py-1 rounded-md text-xs font-medium flex items-center gap-1 ${getCategoryColor(item.category || 'default')}`}>
             ...
             <div className="bg-white rounded-xl shadow-md p-6">
              ...
              <div className="prose max-w-none">
                ...
                <div className="bg-[#f8f9fa] p-4 rounded-lg my-4">
              ...
              <form onSubmit={handleCommentSubmit} className="mb-6">
                <div className="flex gap-3">
                  <input
                    ...
                    className="flex-1 px-4 py-3 border border-[#e5e7eb] rounded-lg focus:outline-none focus:border-[#1344FF] transition-colors"
                  />
                  <button
                    type="submit"
                    className="bg-[#1344FF] text-white px-6 py-3 rounded-lg hover:bg-[#0d34cc] transition-all shadow-sm flex items-center gap-2"
                  >
                      ...
                      <div className="ml-12 mt-4 flex gap-3 animate-in fade-in slide-in-from-top-2 duration-200">
                        ...
                        <form onSubmit={(e) => handleReplySubmit(e, comment.id)} className="flex-1 flex gap-2">
                          <input
                            ...
                            className="flex-1 px-4 py-2 text-sm border border-[#e5e7eb] rounded-lg focus:outline-none focus:border-[#1344FF]"
                            autoFocus
                          />
                          <button
                            type="submit"
                            className="bg-[#1344FF] text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-[#0d34cc]"
                          >
                            등록
                          </button>
                        </form>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-md p-6 sticky top-24">
              <button
                onClick={handleFork}
                className="w-full bg-[#1344FF] text-white py-4 rounded-lg hover:bg-[#0d34cc] transition-all shadow-md font-medium mb-3 flex items-center justify-center gap-2"
              >
              ...
              <div className="flex gap-3 mb-6">
                <button
                  ...
                  className={`flex-1 py-3 rounded-lg border transition-all flex items-center justify-center gap-2 ${
                    isLiked
                ...
                <button
                  onClick={handleShare}
                  className="flex-1 py-3 rounded-lg border border-[#e5e7eb] text-[#666666] hover:border-[#1344FF] hover:text-[#1344FF] transition-all flex items-center justify-center gap-2"
                >
              ...
              <div className="border-t border-[#e5e7eb] pt-4 space-y-3">
                ...
                <div className="flex items-center justify-between text-sm">
                  <span className="text-[#666666]">Fork</span>
