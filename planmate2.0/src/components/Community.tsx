                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1 flex-wrap">
                        {post.isPinned && (
                          <span className="flex items-center gap-1 bg-yellow-100 text-yellow-700 px-2 py-0.5 rounded text-xs font-semibold">
                            <Pin className="w-3 h-3" />
                            공지
                          </span>
                        )}
                        {post.isHot && (
                          <span className="flex items-center gap-1 bg-red-100 text-red-600 px-2 py-0.5 rounded text-xs font-semibold">
                            <TrendingUp className="w-3 h-3" />
                            HOT
                          </span>
                        )}
                        <span className="bg-[#E8EDFF] text-[#1344FF] px-2 py-0.5 rounded text-xs font-medium">
                      ...
                      {post.tags && post.tags.length > 0 && (
                        <div className="flex gap-1 mt-2">
                          {post.tags.map((tag) => (
                            <span
                              key={tag}
                              className="text-xs text-[#1344FF] bg-[#E8EDFF] px-2 py-0.5 rounded"
                            >
                              #{tag}
                            </span>
                          ))}
